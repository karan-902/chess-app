...
export const colorBgLight = "#F6F3EA";
export const colorSurfaceLight = "#FFFFFF";
export const colorBorderLight = "#E7E1CE";
export const colorTextLight = "#85806d";
export const colorMutedLight = "#867F6B";
export const colorGoldLight = "#E1890F";
export const colorGoldContrastLight = "#FFFFFF";
