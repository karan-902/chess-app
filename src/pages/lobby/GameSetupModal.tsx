...
import {
    lobbySetupDifficultySectionTitle,
    lobbySetupTimeControlSectionTitle,
    lobbySetupStartButton,
                    ...
                    <Box customClass="gsm-header-left">
                        <Box customClass="gsm-header-icons">
                            <User
                                size={22}
                                strokeWidth={1.6}
                                className="gsm-header-icon"
                            />
                            <Text as="span" customClass="gsm-header-vs">
                                vs
                            </Text>
                            <ModeIcon
                                size={22}
                            ...
                            <Box customClass="gsm-diff-row">
                                {DIFF_OPTIONS.map(
                                    ({
                                        ...
                                        >
                                            <span className="gsm-diff-icon">
                                                {icon}
                                            </span>
                                            <div className="gsm-diff-text">
                                                <span className="gsm-diff-label">
                                                    {label}
                                                </span>
                                                <span className="gsm-diff-rating">
                                                    {featured ? desc : rating}
                                                </span>
                                            </div>
                                        </button>
                                    ),
                                ...
                                ({
                                    ...
                                    <button
                                        ...
                                        className={clsx(
                                            ...
                                            `gsm-time-btn--${color}`,
                                            featured &&
                                                "gsm-time-btn--featured",
                                            timeControl === key && "active",
                                        )}
                                        onClick={() => onTimeControlChange(key)}
                                    >
                                        <span className="gsm-time-icon">
                                            {icon}
                                        </span>
                                        <div className="gsm-time-text">
                                            <span className="gsm-time-label">
                                                {label}
                                            </span>
                                            <span className="gsm-time-dur">
                                                {featured ? desc : duration}
                                            </span>
                                        </div>
                                    </button>
                                ),
