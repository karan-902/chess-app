...
import { ENGINE_LINES } from '../../constants/config'
import { playEnginePanelEngineLine } from '@/components/messages'
  ...
  return (
    <Card customClass="engine-row">
      ...
      <Box customClass="engine-meta">
        ...
        <Text font="mono" size={10} color="muted">{playEnginePanelEngineLine(line.score)}</Text>
      </Box>
    </Card>
  )
}
