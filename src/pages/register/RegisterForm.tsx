...
import type { IRegisterEmailBody, IVerifyEmailBody, IResendOtpBody } from "@/types/index";
import type { IRegisterResponse, IMessageResponse } from "@/types/utils";
import {
    authLoginBack,
    authEmailLabel,
...
interface IEmailFormScreenProps {
    onBack: () => void;
...
function OtpScreen({ email, onVerified, onBack }: IOtpScreenProps) {
...
export default function RegisterForm() {
    ...
    useEffect(() => {
        if (isProcessing) dispatch(showLoader({ text: "Signing in with Google..." }));
