export const sessionTerminatedTitle = "Session terminated";
export const sessionTerminatedDescription =
...
export const authLoginSubtitle = "Sign in to your KingStake account";
...
export const matchmakingPoolCardPrizeLabel = "prize";
export const matchmakingPoolCardQueued = (n: number) => `${n} queued`;
export const matchmakingPoolCardActive = (n: number) => `${n} active`;
...
export const playToastOpponentDisconnectedDesc =
...
export const playWagerBadgeVsComputerNoWager = "vs Computer · no wager";
...
export const playGameOverNewGameButton = "New Game";
...
export const walletWithdrawExceedsBalance = "Amount exceeds your withdrawable balance.";
...
export const walletFilterTitle = "Filter";
...
export const depositModalStep5Desc =
    "Once confirmed, your KingStake wallet will be credited.";
...
export const leaderboardEyebrow = "ranks --top --earnings";
export const leaderboardTitle = "Leaderboard";
export const leaderboardSubtitle = "Top players ranked by earnings";
...
export const leaderboardTableRankHeader = "#";
export const leaderboardTablePlayerHeader = "Player";
export const leaderboardTableRatingHeader = "Rating";
export const leaderboardTableEarningsHeader = "Earnings";
export const leaderboardTableYouSuffix = "(you)";

export const historyEyebrow = "history --games";
export const historyTitle = "Game History";
export const historySubtitle = "Your recent games will appear here";
export const historyEmptyText = "No games played yet";
export const historyFilterEmptyText = "No games match these filters.";
export const historyResultLabels = { win: "Won", loss: "Lost", draw: "Draw" };
export const historyAbandonedSuffix = "abandoned";
export const historyTimeControlLabel = (minutes: number) => `${minutes} min`;
export const historyFilterTrigger = "Filter ▾";
export const historyFilterSheetTitle = "Filter Games";
export const historyFilterResultLabel = "Result";
export const historyFilterTimeControlLabel = "Time Control";
export const historyFilterAll = "All";
export const historyFilterWins = "Wins";
export const historyFilterLosses = "Losses";
export const historyFilterDraws = "Draws";
export const historyFilterApplyButton = "Apply Filters";
export const historyStatsWinRateLabel = "Win Rate";
export const historyStatsGamesLabel = "Games";
export const historyStatsNetPLLabel = "Net P&L";
...
export const profileRatingsByCategoryLabel = "Ratings by Time Control";
